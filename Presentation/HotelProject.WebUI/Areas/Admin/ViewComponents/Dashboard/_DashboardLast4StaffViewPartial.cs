...
{
    public class _DashboardLast4StaffViewPartial:ViewComponent
    {
        private readonly IHttpClientFactory _httpClientFactory;
        private readonly IApiSettings _apiUrl;

        public _DashboardLast4StaffViewPartial(IHttpClientFactory httpClientFactory, IApiSettings apiUrl)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var responseMessage = await client.GetAsync($"{_apiUrl.BaseUrl}StaffAPI/GetLast4Staff");
